    ...
    <div className="mt-6">
      ...
      >
        ...
        <div className="">
          ...
          {/* Video description */}
          <div className="font-semibold bg-gray-200 px-4 py-2 ml-2 rounded-md ">
            <span>
            ...
            <div className="flex flex-col items-start">
              {/* Properly formatted description with line breaks and clickable links */}
              <p className="font-normal">
                {showMore ? formatDescription(description) : firstLine}
              </p>

              <button
                className="font-semibold mt-4 cursor-pointer self-start" // Margin top added
